    ...
    <section class="flat-row page-profile bg-theme">
        <div class="container">
         ...
         box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <form class="form-login form-listing" action="{{route('tutor_register_user_create')}}" method="post">
                @csrf
            ...
            <span class="input-login icon-form"><input type="password" placeholder="Repeat Password*"
                    name="password_confirmation" required="required"><i class="fa fa-lock"></i></span>
                ...
                <div class="modal-body text-center clearfix">
                    <div class="form-login form-listing" >
                        ...
                        <span class="wrap-button">
                            <button type="button" id="login-button" onclick="verify()" data-dismiss="modal" class=" login-btn effect-button" title="log in">Verify</button>
                        </span>
                    </div>
                </div>
            </div>
