    ...
    <section class="flat-row page-profile bg-theme">
        <div class="container">
         ...
         box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <form class="form-login form-listing" action="{{route('school_institute_register_user_create')}}" method="post" id='form1'>
                @csrf
                ...
                <span class="input-login icon-form">
                    ...
                    <span class="input-login icon-form"><input type="text" id="entity" placeholder=" Name of Entity"  name="name"
                        required="required"><i class="fa fa-user"></i></span>

                <span class="input-login icon-form"><input type="text" placeholder="Contact Person*" name="contact_person"
                        required="required"><i class="fa fa-user"></i></span>

                        <span class="input-login icon-form"><input type="text" placeholder="Mobile No*" id="mob" name="r_mob"
                            required="required"><i class="fa fa-user"></i></span>
                ...
                <span class="input-login icon-form"><input type="password" placeholder="Repeat Password*"
                        name="password_confirmation" required="required"></span>
                         ...
                         <span class="">
                            <button type="button" id="login-button1"   class=" btn"
...
<script>$('#sel').on('change',function(){
        console.log($('#sel').children("option:selected").val());
        $('#entity').attr({"placeholder":' Name of ' + $('#sel').children("option:selected").val()});
