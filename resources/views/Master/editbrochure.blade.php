					...
					<div class="col-md-8 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<form class="row g-2" action="{{route('master.update_brochure')}}" method="post" enctype="multipart/form-data">
									@csrf
						...
						<div class="col-md-8"></div>
							...
							<input type="file" class="form-control" id="inputFirstName" placeholder="Upload Brochure Image" name="brochure_img">
                            <img height="50px" width="50px" src="{{asset('/').$editblog->brochure_img}}" alt="">
						</div>
					...
					<div class="card-body">
						<div class="table-responsive">
							<table id="example" class="table table-striped table-bordered">
								...
								<tbody>
									@foreach ($blogss as $brochuress)
										
						
									<tr>
										<td>{{$loop->index+1}}</td>
										<td><a href="{{asset('/').$brochuress->broucher_img}}">
