					...
					<div class="col-md-8 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<hr>
								<form class="row g-2" action="{{route('master.create_course')}}" method="post">
									@csrf
									
						<div class="col-md-2"></div>
									<div class="col-md-4">
										<label for="inputFirstName" class="form-label">Courses*</label>
										<input type="text" class="form-control" id="inputFirstName" placeholder="Courses" name="course">
									</div>
