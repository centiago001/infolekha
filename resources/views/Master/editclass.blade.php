					...
					<div class="col-md-8 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<hr>
								<form class="row g-2" action="{{route('master.update_clsss')}}" method="post">
									@csrf
									<input type="hidden" name="id" value="{{$cledit->id}}">
						<div class="col-md-2"></div>
									<div class="col-md-4">
										<label for="inputFirstName" class="form-label">Class*</label>
										<input type="text" class="form-control" id="inputFirstName" placeholder="Class" name="class" value="{{$cledit->class}}">
									</div>
