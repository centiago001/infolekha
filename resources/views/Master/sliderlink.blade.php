					...
					<div class="col-md-12 mx-auto" >
						<div class="card">
							<div class="card-body">
								...
								<form class="row g-2" action="{{route('master.create_slider')}}" method="post" enctype="multipart/form-data">
									@csrf
						...
						<div class="col-md-3">
							...
							<input type="text" class="form-control" id="inputFirstName" placeholder="link" name="link">
						</div>
